...
const SimpleCounter = ({ numberSix, numberFive, numberFour, numberThree, numberTwo,
    numberOne, pauseCounter, continueCounter, resetCounter, reduceCounter, activatePromp }) => {
    return (
        <>
            <div className="counter ">
                ...
                <div className='d-flex justify-content-center'>
                    ...
                    <button onClick={activatePromp} type="button" className="btn btn-primary mx-2">Activar Numero para parar contador</button>
